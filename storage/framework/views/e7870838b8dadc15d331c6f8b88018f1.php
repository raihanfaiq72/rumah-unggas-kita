...
<body class="nav-md">
    <div class="container body">
        <div class="main_container">
                ...
                <div class="left_col scroll-view">
                    ...
                    <div class="profile clearfix">
                        <div class="profile_pic">
                            <img src="<?php echo e(url('')); ?>/admin/production/images/img.jpg" alt="..." class="img-circle profile_img">
                        </div>
                        <div class="profile_info">
                            <span>Welcome,</span>
                            <h2><?php echo e(session()->get('nama_lengkap')); ?></h2>
                        </div>
                    </div>
                    <!-- /menu profile quick info -->
                    ...
                    <!-- sidebar menu -->
                    <?php echo $__env->make('Layout/Auth/sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <!-- /sidebar menu -->
                        ...
                        <ul class=" navbar-right">
                            <li class="nav-item dropdown open" style="padding-left: 15px;">
                                <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true"
                                    ...
                                    <img src="<?php echo e(url('')); ?>/admin/production/images/img.jpg" alt=""><?php echo e(session()->get('nama_lengkap')); ?></>
                                </a>
                                ...
                                <ul class="dropdown-menu list-unstyled msg_list" role="menu"
                                    ...
                                    <li class="nav-item">
                                        <a class="dropdown-item">
                                            <span class="image"><img src="<?php echo e(url('')); ?>/admin/production/images/img.jpgimages/img.jpg" alt="Profile Image" /></span>
                                            <span>
                                    ...
                                    <li class="nav-item">
                                        <a class="dropdown-item">
                                            <span class="image"><img src="<?php echo e(url('')); ?>/admin/production/images/img.jpg" alt="Profile Image" /></span>
                                            <span>
                                                <span>John Smith</span>
                                                <span class="time">3 mins ago</span>
                                            </span>
            ...
            <!-- page content -->
            <?php echo $__env->yieldContent('sudahlogin'); ?>
            <!-- /page content --> 
<?php /**PATH C:\xampp\htdocs\rumah-unggas-kita\resources\views/Layout/Auth/header.blade.php ENDPATH**/ ?>