            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(url('user/toko')); ?>/update" method="POST" id="demo-form2" data-parsley-validate
                            class="form-horizontal form-label-left">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
                            <input type="hidden" name="id" value="<?php echo e($toko->id); ?>">
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="first-name" required="required" class="form-control "
                                        name="nama_toko" value="<?php echo e($toko->nama_toko); ?>">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="last-name" name="alamat" required="required"
                                        class="form-control" value="<?php echo e($toko->alamat); ?>">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input id="middle-name" class="form-control" type="text"
                                        value="<?php echo e($toko->nomor_telp); ?>" name="nomor_telp">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input id="middle-name" class="form-control" value="<?php echo e($toko->deskripsi); ?>"
                        ...
                        <div id="formContainer" style="display:none;">
                            <form action="<?php echo e(url('user/toko')); ?>" method="POST" id="demo-form2" data-parsley-validate
                                class="form-horizontal form-label-left">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make($auth, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rumah-unggas-kita\resources\views/Seller/Toko/create.blade.php ENDPATH**/ ?>