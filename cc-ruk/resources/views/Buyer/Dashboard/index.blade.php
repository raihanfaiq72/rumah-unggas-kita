            ...
            <div class="tab-content">
                    ...
                    <div class="row g-4">
                        <div class="col-lg-12">
                            <div class="row g-4">
                                ...
                                @foreach($data->where('kategori',1) as $p)
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="rounded position-relative fruite-item">
                                        <div class="fruite-img">
                                            <img src="{{url('')}}/admin/upload/{{$p->gambar}}"
                ...
                <div id="tab-3" class="tab-pane fade show p-0">
                    <div class="row g-4">
                        <div class="col-lg-12">
                            <div class="row g-4">
                                @foreach($data->where('kategori',2) as $p)
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="rounded position-relative fruite-item">
                                        <div class="fruite-img">
                                            <img src="{{url('')}}/admin/upload/{{$p->gambar}}"
                ...
                <div id="tab-4" class="tab-pane fade show p-0">
                    <div class="row g-4">
                        <div class="col-lg-12">
                            <div class="row g-4">
                                @forelse($data->where('kategori',3) as $p)
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="rounded position-relative fruite-item">
                                        <div class="fruite-img">
                                            <img src="{{url('')}}/admin/upload/{{$p->gambar}}"
                ...
                <div id="tab-5" class="tab-pane fade show p-0">
                    <div class="row g-4">
                        <div class="col-lg-12">
                            <div class="row g-4">
                                @foreach($data->where('kategori',4) as $p)
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="rounded position-relative fruite-item">
                                        <div class="fruite-img">
                                            <img src="{{url('')}}/admin/upload/{{$p->gambar}}"
...
<div class="container-fluid vesitable py-5">
    <div class="container py-5">
        <h1 class="mb-0">Market Unggas Segar</h1>
        <div class="owl-carousel vegetable-carousel justify-content-center">

           @forelse($toko as $p)
           <div class="border border-primary rounded position-relative vesitable-item">
                <div class="vesitable-img">
                    <img src="img/example.webp" class="img-fluid w-100 rounded-top" alt="">
                </div>
                <div class="p-4 rounded-bottom">
                    <h4>{{$p->nama_toko}}</h4>
                    <p>{{$p->deskripsi}}</p>
                    <div class="d-flex justify-content-between flex-lg-wrap">
                        <a href="{{url('toko/'.$p->id)}}" class="btn border border-secondary rounded-pill px-3 text-primary"> Lihat Toko</a>
                    </div>
                </div>
            </div>
           @empty
